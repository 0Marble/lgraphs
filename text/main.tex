...
\begin{figure}
    ...
    \subfloat[\centering Граф с нейтральным циклом]{
        \includegraphics[scale=.5]{graphs/example_neutral.dot.png}
    }
    \qquad
    \subfloat[\centering Граф с парными циклами]{
        \includegraphics[scale=.5]{graphs/example_paired.dot.png}
    }
    \qquad
    \subfloat[\centering Граф с псевдоциклом]{
        \includegraphics[scale=.5]{graphs/example_pseudo.dot.png}
    }
