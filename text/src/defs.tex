...
\begin{figure}
    \centering
    \includesvg[scale=0.5, inkscapeformat=png]{images/graph1.dot.svg}
    \caption{L-граф}
...
\begin{figure}[h]
    \begin{minipage}[h]{0.49\linewidth}
      \center{\includesvg[scale=0.5, inkscapeformat=png]{images/example_determined.dot.svg} \caption{Детерминированный L-граф}}
    \end{minipage}
    \hfill
    \begin{minipage}[h]{0.49\linewidth}
      \center{\includesvg[scale=0.5, inkscapeformat=png]{images/example_nondetermined.dot.svg} \caption{Недетерминированный L-граф}}
    \end{minipage}
    \label{det_vs_nondet}  
  \end{figure}
...
\begin{figure}
    ...
    \subfloat[\centering Граф с нейтральным циклом]{
        \includesvg[scale=.5, inkscapeformat=png]{images/example_neutral.dot.svg}
    }
    \qquad
    \subfloat[\centering Граф с парными циклами]{
        \includesvg[scale=.5, inkscapeformat=png]{images/example_paired.dot.svg}
    }
    \qquad
    \subfloat[\centering Граф с псевдоциклом]{
        \includesvg[scale=.5, inkscapeformat=png]{images/example_pseudo.dot.svg}
    }
...
\begin{figure}[h]
    \centering
    \includesvg[scale=.4, inkscapeformat=png]{images/graph1_path0.dot.svg} (a)\\
    \includesvg[scale=.4, inkscapeformat=png]{images/graph1_path3.dot.svg} (b)\\
    \includesvg[scale=.4, inkscapeformat=png]{images/graph1_path1.dot.svg} (c)\\
    \includesvg[scale=.4, inkscapeformat=png]{images/graph1_path4.dot.svg} (d)\\
